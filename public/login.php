...
if (isset($_POST["go-auth"])) {
    ...
    if ($loginError . $firstPasswordError . $secondPasswordError == '') {
    ...
    if ($userExists) {
        ...
        if($roleResult["id_role"] === '1') {
            if ($nameResult) {
                ...
                $_SESSION["id_user"] = $nameRow[0];
                $_SESSION["full_name"] = $nameRow[1];
                $_SESSION["login"] = $nameRow[2];
                $_SESSION["phone"] = $nameRow[3];
            }
            print "<script language='Javascript' type='text/javascript'>
        ...
        <div class="container main-container login-container">
            ...
            <div class="form-wrapper">
                <form action="login.php" method="post" class="form">
                    <div class="box-input">
                        <label>Логин</label>
                        <input class="input" name="login" type="text" value="<?= @$login;?>" placeholder="">
                    </div>
                    <span class="error"><?= @$loginError; ?></span>

                    <div class="box-input">
                        <label>Пароль</label>
                        <input class="input" name="first-password" type="password" placeholder="Введите пароль" >
                    </div>
                    <span class="error"><?= @$firstPasswordError; ?></span>

                    <div class="box-input">
                        <label>Повторить пароль</label>
                        <input class="input" name="second-password" type="password" placeholder="Повторите пароль">
                    </div>
