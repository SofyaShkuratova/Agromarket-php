...
//БД
if
($nameError.$loginError.$firstPasswordError.$secondPasswordError.$phoneError.$captchaError == '') 
{
        ...
        <div class="form-wrapper">
            <form action="registration.php" method="POST" class="form">
                ...
                <div class="box-input">
                    ...
                    <input type="text" name="login" class="input" value="<?=@$login;?>" required>
                    <span class="error"><?=@$loginError;?></span>
                </div>

                <div class="box-input">
                    <label >Придумайте пароль</label>
                    <input type="password" name="first-password" class="input"  required>
                    <span class="error" style="color: red"><?=@$firstPasswordError;?></span>
                </div>

                <div class="box-input">
                    <label >Повторите пароль</label>
                    <input type="password" name="second-password" class="input"  required>
                    <span class="error"><?=@$secondPasswordError;?></span>
                </div>

                <div class="box-input">
                    <label >Введите номер телефона</label>
                    <input type="text" name="phone" class="input" value="<?=@$phone;?>" required>
                ...
                <input type="submit" name="submit" value="Зарегестрироваться" class="button-submit">
            </form>
            <form action="login.php" method="post" class="reg-form">
                Уже есть свой аккаунт?<input class="registrate-input" type="submit" name="submit" value="Войти">
            </form>
        </div>
    </div>
</section>
